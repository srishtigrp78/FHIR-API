...
@Component
@Document(collection = "AMRIT_Atom_Feeds_Log_Demographic")
public class FeedDataLog {
	...
	@Expose
	@Field(value = "entryContentPatientFull_URL")
	private String entryContentPatientFull_URL;
	...
	public String getEntryContentPatientFull_URL() {
		return entryContentPatientFull_URL;
	}

	public void setEntryContentPatientFull_URL(String entryContentPatientFull_URL) {
		this.entryContentPatientFull_URL = entryContentPatientFull_URL;
	}
