...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = {"com.wipro.fhir.r4.repo", "com.wipro.fhir.r4.*" })
...
//		logger.info(encryptor.decrypt(ConfigProperties.getPropertyByName("encDbPass")));
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages("com.wipro.fhir.r4.data.*").persistenceUnit("db_iemr").build();
	}
